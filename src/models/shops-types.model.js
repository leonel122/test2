...
// shopsTypes-model.js - A Sequelize model. (Can be re-generated.)
//
// See http://docs.sequelizejs.com/en/latest/docs/models-definition/
// for more of what you can do here.
const merge = require('lodash.merge')
// !<DEFAULT> code: sequelize_schema
const sequelizeSchema = require('../services/shops-types/shops-types.sequelize')
// !end
...
let moduleExports = function (app) {
  ...
  const shopsTypes = sequelizeClient.define('shops_types',
  ...
  shopsTypes.associate = function (models) {
