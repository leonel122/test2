...
// shoppingCart-model.js - A Sequelize model. (Can be re-generated.)
//
// See http://docs.sequelizejs.com/en/latest/docs/models-definition/
// for more of what you can do here.
const merge = require('lodash.merge')
// !<DEFAULT> code: sequelize_schema
const sequelizeSchema = require('../services/shopping-cart/shopping-cart.sequelize')
// !end
...
let moduleExports = function (app) {
  ...
  const shoppingCart = sequelizeClient.define('shopping_cart',
  ...
  shoppingCart.associate = function (models) {
    ...
    shoppingCart.belongsTo(usersModel(app), {foreignKey:'user_id',onDelete:'RESTRICT'});        
    // !end
  }
