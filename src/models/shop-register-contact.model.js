...
// shopRegisterContact-model.js - A Sequelize model. (Can be re-generated.)
//
// See http://docs.sequelizejs.com/en/latest/docs/models-definition/
// for more of what you can do here.
const merge = require('lodash.merge')
// !<DEFAULT> code: sequelize_schema
const sequelizeSchema = require('../services/shop-register-contact/shop-register-contact.sequelize')
// !end
...
let moduleExports = function (app) {
  ...
  const shopRegisterContact = sequelizeClient.define('shop_register_contact',
  ...
  shopRegisterContact.associate = function (models) {
