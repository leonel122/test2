...
// shopsShippingCost-model.js - A Sequelize model. (Can be re-generated.)
//
// See http://docs.sequelizejs.com/en/latest/docs/models-definition/
// for more of what you can do here.
const merge = require('lodash.merge')
// !<DEFAULT> code: sequelize_schema
const sequelizeSchema = require('../services/shops-shipping-cost/shops-shipping-cost.sequelize')
// !end
...
let moduleExports = function (app) {
  ...
  const shopsShippingCost = sequelizeClient.define('shops_shipping_cost',
  ...
  shopsShippingCost.associate = function (models) {
