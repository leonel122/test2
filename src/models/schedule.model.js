...
// schedule-model.js - A Sequelize model. (Can be re-generated.)
//
// See http://docs.sequelizejs.com/en/latest/docs/models-definition/
// for more of what you can do here.
const merge = require('lodash.merge')
// !<DEFAULT> code: sequelize_schema
const sequelizeSchema = require('../services/schedule/schedule.sequelize')
// !end
...
let moduleExports = function (app) {
  ...
  const schedule = sequelizeClient.define('schedule',
  ...
  schedule.associate = function (models) {
    ...
    schedule.belongsTo(shopModel(app), {
      foreignKey: "shop_id",
      onDelete: "RESTRICT",
    });
    // !end
